...
00007663 <mkfs>:
    ...
    7a4a:	3d 00 88 00 00       	cmp    $0x8800,%eax
    ...
    7a73:	ba 01 80 00 00       	mov    $0x8001,%edx
    ...
    7cd0:	c7 40 08 00 80 00 00 	movl   $0x8000,0x8(%eax)
...
0000c7ed <execv>:
    ...
    c96e:	74 19                	je     c989 <execv+0x19c>
    c970:	6a 7e                	push   $0x7e
    c972:	68 e4 ee 00 00       	push   $0xeee4
    c977:	68 e4 ee 00 00       	push   $0xeee4
    c97c:	68 ef ee 00 00       	push   $0xeeef
    c981:	e8 57 fb ff ff       	call   c4dd <assertion_failure>
    c986:	83 c4 10             	add    $0x10,%esp
    c989:	8b 85 c4 fb ff ff    	mov    -0x43c(%ebp),%eax
    c98f:	c9                   	leave  
    c990:	c3                   	ret    
    c991:	66 90                	xchg   %ax,%ax
    c993:	66 90                	xchg   %ax,%ax
    c995:	66 90                	xchg   %ax,%ax
    c997:	66 90                	xchg   %ax,%ax
    c999:	66 90                	xchg   %ax,%ax
    c99b:	66 90                	xchg   %ax,%ax
    c99d:	66 90                	xchg   %ax,%ax
    c99f:	90                   	nop
